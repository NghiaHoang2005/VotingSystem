    ...
    <div className="w-full max-w-4xl glass-panel p-8">
      ...
      {result && (
        <div className="grid md:grid-cols-2 gap-6 animate-fade-in">
          ...
          <div className="bg-green-900/20 p-6 rounded-xl border border-green-500/50 flex flex-col justify-center items-center text-center">
            <h3 className="font-bold text-green-400 mb-4">Kết quả từ Authority Server</h3>
            <div className="text-sm text-slate-400 mb-2">Số người bầu YES (ĐỒNG Ý):</div>
            <div className="text-7xl font-black text-green-400 drop-shadow-[0_0_20px_rgba(34,197,94,0.6)]">
              {result.final_yes_votes}
            </div>
            <div className="mt-4 text-slate-300">
              Số người bầu NO (TỪ CHỐI): <b className="text-white">{result.total_ballots - parseInt(result.final_yes_votes)}</b>
            </div>
          </div>
        </div>
      )}
